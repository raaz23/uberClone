...
const CaptainRegister = () => {
    ...
    function handleCaptainRegister(e){
        e.preventDefault();
        const captainData = {
  ...
  return (
    ...
    <div className="flex flex-1 items-center justify-center px-6 lg:px-20">
      ...
      <div className=" flex justify-center flex-col p-4 rounded-lg">
        ...
        {/* Heading */}
        <h1 className="text-3xl font-semibold text-gray-800 flex justify-center mb-5 ">Captain Register</h1>
        <p className="text-gray-600 flex justify-center gap-5 mt-2">Please enter your credentials to Register.</p>
        </div>
        {/* Form */}
        <form className="space-y-4" onSubmit={handleCaptainRegister}>
        ...
        <p className="text-center text-gray-600 text-sm">
          ...
          <a href="/captainLogin" className="text-black font-semibold hover:underline">
            Login
          </a>
        </p>
      </div>
